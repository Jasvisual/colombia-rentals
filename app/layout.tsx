        ...
        <header className="bg-white shadow-sm sticky top-0 z-40">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-gray-100 bg-white">
              <div className="px-4 py-8 space-y-5 flex flex-col items-center text-center">
                <Link
                  href="/"
                  onClick={() => setMobileMenuOpen(false)}
                  className="block text-gray-700 hover:text-emerald-600 transition-colors font-medium text-lg py-2"
                >
                  Inicio
                </Link>
                <a
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white text-base font-semibold px-8 py-3 rounded-xl transition-all duration-200 mt-2"
                >
